...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _XCAFNoteObjects.SWIG_PyInstanceMethod_New(func)
else:
...
class SwigPyIterator(object):
    ...
    def __iter__(self):
        return self
SwigPyIterator.value = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_value, None, SwigPyIterator)
SwigPyIterator.incr = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_incr, None, SwigPyIterator)
SwigPyIterator.decr = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_decr, None, SwigPyIterator)
SwigPyIterator.distance = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_distance, None, SwigPyIterator)
SwigPyIterator.equal = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_equal, None, SwigPyIterator)
SwigPyIterator.copy = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_copy, None, SwigPyIterator)
SwigPyIterator.next = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_next, None, SwigPyIterator)
SwigPyIterator.__next__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___next__, None, SwigPyIterator)
SwigPyIterator.previous = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_previous, None, SwigPyIterator)
SwigPyIterator.advance = new_instancemethod(_XCAFNoteObjects.SwigPyIterator_advance, None, SwigPyIterator)
SwigPyIterator.__eq__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___eq__, None, SwigPyIterator)
SwigPyIterator.__ne__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___ne__, None, SwigPyIterator)
SwigPyIterator.__iadd__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___iadd__, None, SwigPyIterator)
SwigPyIterator.__isub__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___isub__, None, SwigPyIterator)
SwigPyIterator.__add__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___add__, None, SwigPyIterator)
SwigPyIterator.__sub__ = new_instancemethod(_XCAFNoteObjects.SwigPyIterator___sub__, None, SwigPyIterator)
...
XCAFNoteObjects_NoteObject.GetPlane = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_GetPlane, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.GetPoint = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_GetPoint, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.GetPointText = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_GetPointText, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.GetPresentation = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_GetPresentation, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.HasPlane = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_HasPlane, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.HasPoint = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_HasPoint, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.HasPointText = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_HasPointText, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.Reset = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_Reset, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.SetPlane = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_SetPlane, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.SetPoint = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_SetPoint, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.SetPointText = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_SetPointText, None, XCAFNoteObjects_NoteObject)
XCAFNoteObjects_NoteObject.SetPresentation = new_instancemethod(_XCAFNoteObjects.XCAFNoteObjects_NoteObject_SetPresentation, None, XCAFNoteObjects_NoteObject)
